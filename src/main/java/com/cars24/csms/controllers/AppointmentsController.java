...
//    }
    ...
    public ResponseEntity<AppointmentsEntity> getAppointments(@Valid @PathVariable Integer appointment_id)
    {
        ...
        log.info("[In get controller] getCustomerRequest{}",appointment_id);
...
//        GetAppointmentsRequest getAppointmentsRequest2 = new GetAppointmentsRequest();
//        response.setAppointment_id(getAppointmentsRequest2.getAppointment_id());
...
//        System.out.println("[createAppointments] createAppointmentRequest {}" + createAppointmentsRequest);
